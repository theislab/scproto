...
class ExperimentRunner:
    def __init__(
        ...
        self.defaults = get_swav_defaults()
    ...
    def run_multiple_experiments(self, item_to_test, submit=False, max_jobs=10):
...
if __name__ == "__main__":
    ...
    items_to_test = [
        {
            ...
            "augmentation_type": ["knn", "scanpy_knn"],
        },
        {
    ...
    for item_to_test in items_to_test:
        # Run all experiments
        runner.run_multiple_experiments(item_to_test, True, 15)
